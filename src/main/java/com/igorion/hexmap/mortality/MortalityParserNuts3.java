...
//
//        List<INutsRegion> nuts3Regions = NutsRegions.getRegions(FILE_NUTS3______GKZ, FILE_GKZ_POPULATION);
//        INutsRegion nuts3Region = nuts3Regions.get(0);
...
//
//        IMortality mortality = Mortality.optMortalityByNuts3(nuts3Region.getNuts(), FILE_NUTS3_AGE_WEEK).orElseThrow();
//
