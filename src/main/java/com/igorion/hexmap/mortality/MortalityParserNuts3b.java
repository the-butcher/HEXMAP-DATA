...
public class MortalityParserNuts3b {
    ...
    public static void main(String[] args) throws Exception {
        ...
        Map<String, INutsRegion> nutsRegions = NutsRegions.getRegions(FILE_GKZ_POPULATION, EAgeGroup.ETOTAL);
        ...
        try (BufferedReader csvReader = new BufferedReader(new InputStreamReader(new FileInputStream(FILE_NUTS3_AGE_WEEK), StandardCharsets.UTF_8))) {
            ...
            for (IDataEntry<String, Long> csvRecord : csvRecords) {
                ...
                if (sex.equals("SEXWO-0")) {
                    ...
                    double weeklyMortalityRate = nutsMortality.get(bkz).getWeeklyMortality(nutsRegions.get(bkz), EAgeGroup.ETOTAL, date);
            ...
            for (String displayNuts : nutsRegions.keySet()) {
                ...
                for (long instant = POP_DATE_STATS_A.getTime(); instant <= POP_DATE_STATS_B.getTime(); instant += DateUtil.MILLISECONDS_PER__DAY * 7) {
                    ...
                    for (int year = 2010; year <= 2019; year++) {
                        ...
                        double mortalityVal0 = refMortality.getWeeklyMortality(refRegion, EAgeGroup.ETOTAL, date0);
                ...
                ImageIO.write(bi, "png", new File("mortality_2_" + displayNuts + ".png"));
